...
export default class Timer extends EventSource{
    constructor(rootEl) {
        super();
        this.rootEl = rootEl;
        this.showEl = this.rootEl.querySelector('span');
        this.startBtn = this.rootEl.querySelector('[date-action="start"]');
        this.stopBtn = this.rootEl.querySelector('[date-action="stop"]');
